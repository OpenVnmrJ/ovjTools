/*
 * @(#)pres_psReaderWriter.h    generated by: makeheader    Mon Dec  3 23:08:15 2007
 *
...
extern PRESDllExport RTIBool 
PRESPsReader_addSample(struct PRESPsReader *me, 
...
PRESPsReader_getSubscriptionMatchStatus(
    struct PRESPsWriter *writer, struct PRESSubscriptionMatchStatus *status,
    struct REDAWorker *worker);
...
/*e \ingroup PRESPsReaderModule 
  @brief Get GUID of reader
*/
extern PRESDllExport RTIBool
...
PRESPsWriter_getOfferedIncompatibleQosStatus(
    ...
    struct PRESOfferedIncompatibleQosStatus *status, struct REDAWorker *worker);
...
extern PRESDllExport
RTIBool
PRESPsWriter_getLocalWriterStatistics(
    struct PRESPsWriter *self,
    int *failReason,
    struct PRESPsWriterLocalWriterStatistics *stats,
    struct REDAWorker *worker);

extern PRESDllExport
RTIBool
PRESPsWriter_getMatchedReadersStatistics(
    struct PRESPsWriter *self,
    int *failReason,
...
extern PRESDllExport
RTIBool
PRESPsWriter_getMatchedDestinationsStatistics(
    struct PRESPsWriter *self,
    int *failReason,
    struct PRESPsWriterStatisticsListener *presStatsListener,
    struct REDAWorker *worker);
...
extern PRESDllExport
RTIBool
PRESPsWriter_resetPeakStatistics(
        struct PRESPsWriter *self,
        int *failReason,
        struct REDAWorker *worker);
...
extern PRESDllExport
RTIBool
PRESPsReader_getLocalReaderStatistics(
    struct PRESPsReader *self,
    int *failReason,
    struct PRESPsReaderLocalReaderStatistics *stats,
    struct REDAWorker *worker);

extern PRESDllExport
RTIBool
PRESPsReader_getMatchedWritersStatistics(
    struct PRESPsReader *self,
    int *failReason,
...
extern PRESDllExport
RTIBool
PRESPsReader_resetPeakStatistics(
    struct PRESPsReader *self,
    int *failReason,
    struct REDAWorker *worker);
