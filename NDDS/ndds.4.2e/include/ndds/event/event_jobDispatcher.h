/*
 * @(#)event_jobDispatcher.h    generated by: makeheader    Mon Dec  3 23:07:59 2007
 *
 ...
 */
#define  RTI_EVENT_JOB_DISPATCHER_STORAGE_LENGTH (6)
/*e \ingroup RTIEventJobDispatcherClass
  @brief Size of priority.
 */
#define  RTI_EVENT_JOB_DISPATCHER_PRIORITY_LENGTH (2)
...
struct RTIEventJobDispatcherTokenBucket *RTIEventJobDispatcher_assertTokenBucket(
    ...
    REDAOrderedDataTypeCompareFunction priorityCompareFnc,
...
struct RTIEventJobDispatcherAgent *RTIEventJobDispatcher_assertAgent(
    ...
    const struct RTIEventJobDispatcherStorage *agentStorage, const struct RTIEventJobDispatcherAgentProperty *property, struct REDAWorker *worker);
...
struct RTIEventJobDispatcherGroup *RTIEventJobDispatcher_assertGroup(
    ...
    const struct RTIEventJobDispatcherStorage *groupStorage, const struct RTIEventJobDispatcherGroupProperty *property, struct REDAWorker *worker);
...
RTIBool RTIEventJobDispatcher_retrieveJobInfo(
    ...
    struct RTIEventJobDispatcherJobPriority *jobPriority,
    int *unitsRequested,
    struct RTIEventJobDispatcherStorage *jobStorage, 
...
void RTIEventJobDispatcher_scheduleJob(
    ...
    struct RTIEventJobDispatcherDefinedJob *definedJob, RTIBool allowDuplicateJob, 
