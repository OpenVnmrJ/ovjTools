/*
 * @(#)dds_c_domain_impl.h    generated by: makeheader    Mon Dec  3 23:08:26 2007
 *
...
DDS_DomainParticipantFactory_initialize_startup_log_handlerI(
        DDS_DomainParticipantFactoryGetVersionStringFn get_version);
...
extern DDSCDllExport
DDS_DataTypeUtility* DDS_DomainParticipant_lookup_typeI(
    DDS_DomainParticipant *self, const char* type_name);
