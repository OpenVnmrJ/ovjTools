/*
 * @(#)dds_c_flowcontroller.h    generated by: makeheader    Mon Dec  3 23:08:27 2007
 *
...
DDS_ReturnCode_t DDS_FlowController_set_property(
    DDS_FlowController *self, const struct DDS_FlowControllerProperty_t *property);

extern DDSCDllExport
DDS_ReturnCode_t DDS_FlowController_get_property(
    DDS_FlowController *self, struct DDS_FlowControllerProperty_t *property);
