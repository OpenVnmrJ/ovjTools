/*
 * @(#)reda_fastBuffer.h    generated by: makeheader    Mon Dec  3 23:07:54 2007
 *
...
struct REDAFastBufferStat {
    ...
    int heapMemCurrentUse;
    /*e maximum heap usage in Bytes */
    int heapMemHighWatermark;
    /*e minimum heap usage in Bytes */
    int heapMemLowWatermark;
    ...
    int fbMemHighWatermark;
    /*e minimum fast-buffer usage in Bytes */
    int fbMemLowWatermark;
