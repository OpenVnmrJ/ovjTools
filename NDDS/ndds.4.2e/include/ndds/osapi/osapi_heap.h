/*
 * @(#)osapi_heap.h    generated by: makeheader    Mon Dec  3 23:07:48 2007
 *
 *		built from:	heap.ifc
 */
...
extern RTIOsapiDllExport void
RTIOsapiHeap_allocateBufferAligned(char **buffer, int size, 
                                   RTIOsapiAlignment alignment);

extern RTIOsapiDllExport void
RTIOsapiHeap_reallocateBufferAligned(char **buffer, int size, 
                                   RTIOsapiAlignment alignment);

extern RTIOsapiDllExport void
RTIOsapiHeap_allocateBufferNotAligned(char **buffer, int size);

extern RTIOsapiDllExport void
RTIOsapiHeap_allocateBuffer(char **buffer, int size, 
                            RTIOsapiAlignment alignment);

extern RTIOsapiDllExport RTIBool
RTIOsapiHeap_reallocateBuffer(char *buffer, int size);
...
extern RTIOsapiDllExport void *RTIOsapiHeap_malloc(int size);

extern RTIOsapiDllExport void *RTIOsapiHeap_calloc(int numElem, int elemSize);

extern RTIOsapiDllExport void *RTIOsapiHeap_realloc(void *ptr, int size);

extern RTIOsapiDllExport void RTIOsapiHeap_free(void *ptr, int size);
