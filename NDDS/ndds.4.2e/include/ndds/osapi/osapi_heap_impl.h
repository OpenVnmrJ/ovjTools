/*
 * @(#)osapi_heap_impl.h    generated by: makeheader    Mon Dec  3 23:07:47 2007
 *
...
RTIOsapiHeap_reallocateMemoryInternal( void **ptr, int size, int alignment,
...
#define RTIOsapiHeap_reallocateBufferNotAligned(buffer, size) \
    RTIOsapiHeap_reallocateMemoryInternal( (void **)(buffer),                  \
                                          (size), RTI_OSAPI_ALIGNMENT_DEFAULT, \
                                          RTI_TRUE, RTI_FALSE,                 \
...
/*--------------------------------------------------------------------------*/
#define RTIOsapiHeap_malloc(size) \
    RTIOsapiHeap_reallocateMemoryInternal(NULL,                        \
                                          (size),                      \
                                          RTI_OSAPI_ALIGNMENT_DEFAULT, \
                                          RTI_FALSE, RTI_FALSE,        \
                                          "RTIOsapiHeap_malloc",       \
...
/*--------------------------------------------------------------------------*/
#define RTIOsapiHeap_calloc(numElem, elemSize) \
    RTIOsapiHeap_reallocateMemoryInternal(NULL,                        \
                                          (numElem)*(elemSize),        \
                                          RTI_OSAPI_ALIGNMENT_DEFAULT, \
                                          RTI_FALSE, RTI_FALSE,        \
