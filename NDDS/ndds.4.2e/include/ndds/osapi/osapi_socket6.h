/*
 * @(#)osapi_socket6.h    generated by: makeheader    Mon Dec  3 23:07:48 2007
 *
...
#if (defined(RTI_IPV6) && !(defined(RTI_UNIX) || defined(RTI_WINCE) || defined(RTI_WIN32)))
    #error Need to port
#endif
...
extern RTIOsapiDllExport RTIBool RTIOsapiSocket_create(/* RTIOsapiSocketType */);
...
#if defined(RTI_SOL210)
  /* Transport priority for IPv6 (TCLASS) only supported on Solaris 10 */
