/*
 * @(#)mig_generator_impl.h    generated by: makeheader    Mon Dec  3 23:08:07 2007
 *
...
#define MIGGeneratorSample_isValid(me)           \
    (me != NULL &&                             \
     (((me)->userData.pointer == NULL ||       \
       ((me)->userData.length & 0x3) == 0)) && \
