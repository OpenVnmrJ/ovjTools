/*
 * @(#)cdr_type.h    generated by: makeheader    Mon Dec  3 23:08:01 2007
 *
 *		built from:	type.ifc
 */
...
typedef RTI_UINT32 RTICdrUnsignedLong;
  ...
  typedef unsigned __int64 RTICdrUnsignedLongLong;
    ...
    */
    typedef unsigned long long RTICdrUnsignedLongLong;
  #else
    typedef struct RTICdrLongLong {
	char bytes[8];
    } RTICdrLongLong;
    typedef struct RTICdrUnsignedLongLong {
	char bytes[8];
    } RTICdrUnsignedLongLong;
  #endif /* RTI_CDR_SIZEOF_LONG_LONG == 8 */
...
typedef unsigned int (*RTICdrTypeGetMaxSizeSerializedFunction)
    (unsigned int currentAlignment);


typedef unsigned int (*RTICdrTypeGetMaxSizeSerializedEncapsulatedFunction)
    (unsigned int currentAlignment);
